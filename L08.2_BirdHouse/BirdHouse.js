...
(function (L08_2_BirdHouse) {
    ...
    function drawBird() {
        for (let index = 0; index < 10; index++) {
            let x = Math.floor(Math.random() * (800 - (-50)) - 50);
            let y = Math.floor(Math.random() * (500 - (10)) - 10);
    ...
    function drawBird2() {
        for (let index = 0; index < 10; index++) {
            let x = Math.floor(Math.random() * (800 - (-50)) - 50);
            let y = Math.floor(Math.random() * (1900 - (100)) - 100);
            let scale = (Math.random() * (0.5 - 0.2) + 0.2);
            crc2.lineWidth = 1;
            // Schnabel
            crc2.save();
            crc2.beginPath();
    ...
    function drawSnowflakes() {
        for (let index = 0; index < 1500; index++) {
            let x = Math.floor(Math.random() * (1080 - 1) + 1);
            let y = Math.floor(Math.random() * (1920 - 1) + 1);
...
})(L08_2_BirdHouse || (L08_2_BirdHouse = {}));
