...
(function (L10_2_BirdHousePolymorphie) {
    ...
    L10_2_BirdHousePolymorphie.handleload = handleload;
    function create() {
        for (let index = 0; index < 1500; index++) {
            let randscale = Math.floor(Math.random() * (3 - 1) + 1);
            let snowflake = new L10_2_BirdHousePolymorphie.Snowflake(randscale);
            moveables.push(snowflake);
        }
        for (let indexbird = 0; indexbird < 10; indexbird++) {
            let randomscale = (Math.random() * (0.4 - 0.2) + 0.2);
            let bird = new L10_2_BirdHousePolymorphie.Bird(randomscale);
            moveables.push(bird);
        }
    }
    function update() {
    ...
    L10_2_BirdHousePolymorphie.drawBackground = drawBackground;
